...
$CP_CONFIG   = $app->retrieve('copilot', []);
$CP_ROUTE    = '/';
...
# cli scripts
$site->path('cli' , dirname(__DIR__).'/cli');
...
$site->service('shortcodes', function() use($site) {
    ...
    $shortcodes = new Copilot\Lib\ShortCodes();

    $site->on('copilot.page.content', function($page, $content) use($shortcodes) {
